...
?>
            ...
            <div class="flex h-full flex-col overflow-y-scroll bg-white py-4 dark:bg-dark-800 dark:text-slate-400">
                <div class="flex justify-between items-center px-4 ">
                    ...
                    <div class="flex gap-x-3">
                        ...
                        <div class="mobile__theme-switcher bg-gray-100 text-slate-500 p-3 rounded-full dark:bg-white/5 dark:text-white">
                            <!-- sun icon -->
                        ...
                        <div id="mobile__sidebar__close-btn" class="bg-gray-100 text-slate-500 p-3 rounded-full dark:bg-white/5 dark:text-white">
                ...
                <div class="px-4 mt-6">
                    <div class="flex items-baseline justify-between text-sm">
                        ...
                        <div class="md:block relative" x-data="{lang: false}">
                            <div x-on:click="lang = !lang" class="bg-red-200 py-1 space-x-4 px-3 pl-7 text-sm rounded-xl dark:text-black"> فارسی -
                                fa </div>
                            <ul class="absolute -top-20 left-0 rounded-xl bg-red-200 min-w-28 text-sm dark:text-black" x-show="lang" x-transition.origin.bottom="" @click.outside="lang=false" style="display: none;">
                                <li class="p-2 hover:text-blue-600 dark:hover:text-blue-600 transition-all duration-200 ease-linear hover:mr-2">
                                    <a href="/fa">
                                        فارسی - fa
                                    </a></li>
                                <li class="p-2 hover:text-blue-600 dark:hover:text-blue-600 transition-all duration-200 ease-linear hover:mr-2">
                            ...
                            <svg class="absolute top-1 left-1 text-black pointer-events-none h-4 w-4" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
        ...
        <div class="container mt-2">
            <div class="flex gap-2 items-center justify-between p-3 shadow-primary rounded-xl bg-white/90 relative z-20 backdrop-blur-lg border-b border-slate-200 w-full dark:border-slate-800 dark:bg-dark-800">
                ...
                <div class="hidden md:block">
                    <input type="text" placeholder="جست و جو ..." class="bg-slate-200 placeholder-slate-800 py-3 px-4 text-xs rounded-xl border-none outline-none w-24 md:w-80">
                </div>
                <div class="flex gap-4 items-center">
                    <!-- Theme switcher in mobile mode -->
                    <div class="mobile__theme-switcher hidden md:block bg-gray-100 text-slate-500 p-3 rounded-full dark:bg-white/5 dark:text-white">
                        <!-- sun icon -->
                        <svg fill="currentColor" class="w-6 h-6 hidden dark:inline-block" viewBox="0 0 16 16">
                            <path d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6m0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8M8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0m0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13m8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5M3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8m10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0m-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0m9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707M4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708"></path>
                        </svg>
                    ...
                    <div class="hidden md:block relative" x-data="{lang: false}">
                        <span x-on:click="lang = !lang" class="bg-slate-200 py-3 space-x-4 px-3 pl-7 text-xs rounded-xl"> فارسی - fa </span>
                        <ul class="absolute top-10 rounded-xl bg-slate-200 min-w-28 text-sm" x-show="lang" x-transition.origin.top="" @click.outside="lang=false" style="display: none;">
                            <li class="p-2 hover:text-blue-600 dark:hover:text-blue-600 transition-all duration-200 ease-linear hover:mr-2">
                                <a href="#">
                                    فارسی - fa
                                </a></li>
                        ...
                        <svg class="absolute top-1 left-2 pointer-events-none h-4 w-4" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M4.22 6.22a.75.75 0 0 1 1.06 0L8 8.94l2.72-2.72a.75.75 0 1 1 1.06 1.06l-3.25 3.25a.75.75 0 0 1-1.06 0L4.22 7.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd"></path>
                        </svg>
                    </div>
                    <div class="hidden md:flex">
                        ...
                        <a href="#" class="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 transition-all text-white -mr-5 py-3 px-3 text-xs rounded-xl">
                            <span>ثبت نام</span>
    ...
    <main class="dark:bg-dark-850 z-10 pt-24">
        ...
        <section class="relative group">
            <div class="container">
                <div class="">
                    <div class="swiper head-slider rounded-xl h-full swiper-fade swiper-initialized swiper-horizontal swiper-rtl swiper-watch-progress swiper-backface-hidden">
                        <!-- Additional required wrapper -->
                        <div class="swiper-wrapper max-h-64 md:max-h-[480px]" id="swiper-wrapper-10f3ed497f8eb35e4" aria-live="polite">
                            <!-- Slides -->
                            <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="width: 1512px; opacity: 1; transform: translate3d(0px, 0px, 0px);" role="group" aria-label="1 / 3">
                                <img src="files/001_002.jpg" alt="" class="w-full h-64 md:h-[480px]">
                            </div>
                            <div class="swiper-slide swiper-slide-next" style="width: 1512px; opacity: 0; transform: translate3d(1512px, 0px, 0px);" role="group" aria-label="2 / 3">
                                <img src="files/002.jpg" alt="" class="w-full h-64 md:h-[480px]">
                            </div>
                            <div class="swiper-slide" style="width: 1512px; opacity: 0; transform: translate3d(3024px, 0px, 0px);" role="group" aria-label="3 / 3">
                        ...
                        <div class="swiper-button-prev swiper-button-disabled swiper-button-lock" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-0c104f6ef995b9531" aria-disabled="true"></div>
                        <div class="swiper-button-next swiper-button-disabled swiper-button-lock" tabindex="-1" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-0c104f6ef995b9531" aria-disabled="true"></div>
            ...
            <div class="container">
                <div class="flex flex-row justify-around">
                    <div class="flex flex-row items-stretch">
                        ...
                        <h3 class="flex flex-col gap-y-2 text-sm text-slate-200 p-4 pr-2 bg-gradient-to-tl from-blue-600 from-50% to-slate-300 rounded-l-xl">
            ...
            <div class="container">
                <div class="flex items-center justify-between bg-gradient-to-l from-blue-200 to-transparent p-4 sm:pr-5 rounded-xl">
                    <div class="flex items-baseline sm:gap-x-3">
                        ...
                        <h2 class="text-2xl font-bold"><?=get_term(pll_get_term( get_term_by( 'slug', 'scientific_event', 'category' )->term_id))->name;?></h2>
                    </div>
                    <a href="#" class="flex items-center group">
                        <span class="rounded-xl leading-9 px-3 -ml-4 group-hover:-ml-3 transition-all bg-white z-10 text-sm"><?=get_term(pll_get_term( get_term_by( 'slug', 'scientific_event', 'category' )->term_id))->name;?></span>
                        <i class="fa-solid fa-arrow-left-to-arc text-white leading-9 pl-3 pr-6 bg-blue-500 group-hover:bg-blue-300 transition-all rounded-tl-xl rounded-bl-xl"></i>
                    </a>
                </div>
            </div>
            <!-- News section body -->
                ...
                <div class="mt-6 rounded-xl bg-gradient-to-br from-transparent from-60% to-blue-200 dark:to-dark-900">
                    ...
                    <div class="swiper news-slider p-5 swiper-initialized swiper-horizontal swiper-rtl swiper-backface-hidden">
                        ...
                        <div class="swiper-wrapper" id="swiper-wrapper-6e077e1052bb863d1" aria-live="polite">
                            ...
                            <div class="swiper-slide swiper-slide-active" style="width: 356px; margin-left: 16px;" role="group" aria-label="1 / 5">
                                <div class="p-4 shadow-primary rounded-2xl dark:bg-dark-800">
                                    <div class="relative">
                                        ...
                                        <div class="flex flex-col items-center w-fit shadow-lg p-3 gap-2 bg-white text-sm rounded-xl absolute left-5 -bottom-1/4">
                                    ...
                                    <div class="flex items-center w-fit shadow-primary text-slate-600 text-sm rounded-lg px-4 py-2 gap-2 mt-3 dark:bg-white">
                                        <svg fill="currentColor" class="w-4 h-4" viewBox="0 0 16 16">
            ...
            <div class="container">
                <div class="flex items-center justify-between bg-gradient-to-l from-blue-200 to-transparent p-4 sm:pr-5 rounded-xl">
                    <div class="flex items-baseline sm:gap-x-3">
                        ...
                        <h2 class="text-2xl font-bold"><?=get_term(pll_get_term( get_term_by( 'slug', 'international-office-news', 'category' )->term_id))->name;?></h2>
                    </div>
                    <a href="#" class="flex items-center group">
                        <span class="rounded-xl leading-9 px-3 -ml-4 group-hover:-ml-3 transition-all bg-white z-10 text-sm"><?=get_term(pll_get_term( get_term_by( 'slug', 'international-office-news', 'category' )->term_id))->name;?></span>
                        <i class="fa-solid fa-arrow-left-to-arc text-white leading-9 pl-3 pr-6 bg-blue-500 group-hover:bg-blue-300 transition-all rounded-tl-xl rounded-bl-xl"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="container">
                <div class="flex items-center justify-between bg-gradient-to-l from-blue-200 to-transparent p-4 sm:pr-5 rounded-xl">
                    <div class="flex items-baseline sm:gap-x-3">
                        ...
                        <h2 class="text-2xl font-bold"><?=get_term(pll_get_term( get_term_by( 'slug', 'al-zahra-university-news', 'category' )->term_id))->name;?></h2>
                    </div>
                    <a href="#" class="flex items-center group">
                        <span class="rounded-xl leading-9 px-3 -ml-4 group-hover:-ml-3 transition-all bg-white z-10 text-sm"><?=get_term(pll_get_term( get_term_by( 'slug', 'al-zahra-university-news', 'category' )->term_id))->name;?></span>
                        <i class="fa-solid fa-arrow-left-to-arc text-white leading-9 pl-3 pr-6 bg-blue-500 group-hover:bg-blue-300 transition-all rounded-tl-xl rounded-bl-xl"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="container">
                <div class="flex items-center justify-between bg-gradient-to-l from-blue-200 to-transparent p-4 sm:pr-5 rounded-xl">
                    <div class="flex items-baseline sm:gap-x-3">
                        ...
                        <h2 class="text-2xl font-bold"><?=get_term(pll_get_term( get_term_by( 'slug', 'international_news', 'category' )->term_id))->name;?></h2>
                    </div>
                    <a href="#" class="flex items-center group">
                        <span class="rounded-xl leading-9 px-3 -ml-4 group-hover:-ml-3 transition-all bg-white z-10 text-sm"><?=get_term(pll_get_term( get_term_by( 'slug', 'international_news', 'category' )->term_id))->name;?></span>
                        <i class="fa-solid fa-arrow-left-to-arc text-white leading-9 pl-3 pr-6 bg-blue-500 group-hover:bg-blue-300 transition-all rounded-tl-xl rounded-bl-xl"></i>
                    </a>
                </div>
            </div>
        ...
        <section class="mt-10">
            <div>
                ...
                <div class="mt-10">
                    <div class="container">
                        <div class="swiper education-group-slider rounded-xl relative swiper-initialized swiper-horizontal swiper-rtl swiper-backface-hidden">
                            <!-- Additional required wrapper -->
                            <div class="swiper-wrapper" id="swiper-wrapper-07c7e65bcd717108f" aria-live="polite">
                                    ...
                                    <div class="flex justify-center">
                                        <div class="bg-gradient-to-br from-transparent to-red-200 rounded-xl dark:bg-dark-800 dark:bg-none">
                                            <div class="w-full p-4">
                                                <a href="#" class="inline-block h-48 overflow-hidden rounded-xl shadow-lg"><img class="w-full h-full transform transition duration-300 hover:scale-110" src="files/architect-400x300.jpg.webp" alt=""></a>
                                            </div>
                                            <div class="px-4 pb-4">
                                                <h3>
                                ...
                                <div class="swiper-slide swiper-slide-next" style="width: 378px;" role="group" aria-label="2 / 5">
                                    <div class="flex justify-center">
                                        <div class="bg-gradient-to-br from-transparent to-red-200 rounded-xl dark:bg-dark-800 dark:bg-none">
                                            <div class="w-full p-4">
                                                <a href="#" class="inline-block h-48 overflow-hidden rounded-xl shadow-lg"><img class="w-full h-full transform transition duration-300 hover:scale-110" src="files/islamic-history-400x300.jpg" alt=""></a>
                                            </div>
                                            <div class="px-4 pb-4">
                                                <h3>
                                                    <a href="#" class="flex items-center p-1 bg-white rounded-xl shadow-lg">
                                ...
                                <div class="swiper-slide" style="width: 378px;" role="group" aria-label="3 / 5">
                                    <div class="flex justify-center">
                                        <div class="bg-gradient-to-br from-transparent to-red-200 rounded-xl dark:bg-dark-800 dark:bg-none">
                                            <div class="w-full p-4">
                                                <a href="#" class="inline-block h-48 overflow-hidden rounded-xl shadow-lg"><img class="w-full h-full transform transition duration-300 hover:scale-110" src="files/civilengineer-400x300.webp" alt=""></a>
                                            </div>
                                            <div class="px-4 pb-4">
                                                <h3>
                                                    <a href="#" class="flex items-center p-1 bg-white rounded-xl shadow-lg">
                                ...
                                <div class="swiper-slide" style="width: 378px;" role="group" aria-label="4 / 5">
                                    <div class="flex justify-center">
                                        <div class="bg-gradient-to-br from-transparent to-red-200 rounded-xl dark:bg-dark-800 dark:bg-none">
                                            <div class="w-full p-4">
                                                <a href="#" class="inline-block h-48 overflow-hidden rounded-xl shadow-lg"><img class="w-full h-full transform transition duration-300 hover:scale-110" src="files/gavel-with-books-old-wooden-desk-400x300.jpg" alt=""></a>
                                            </div>
                                            <div class="px-4 pb-4">
                                                <h3>
                                                    <a href="#" class="flex items-center p-1 bg-white rounded-xl shadow-lg">
                                ...
                                <div class="swiper-slide" style="width: 378px;" role="group" aria-label="5 / 5">
                                    <div class="flex justify-center">
                                        <div class="bg-gradient-to-br from-transparent to-red-200 rounded-xl dark:bg-dark-800 dark:bg-none">
                                            <div class="w-full p-4">
                                                <a href="#" class="inline-block h-48 overflow-hidden rounded-xl shadow-lg"><img class="w-full h-full transform transition duration-300 hover:scale-110" src="files/front-view-plant-growing-from-golden-coins-400x300.jpg" alt=""></a>
                                            </div>
                                            <div class="px-4 pb-4">
                                                <h3>
                                                    <a href="#" class="flex items-center p-1 bg-white rounded-xl shadow-lg">
        ...
        <section class="mt-10">
            <div class="container">
                ...
                <div class="flex flex-col items-center pt-10">
                    <h3 class="flex items-center justify-center text-slate-900 dark:text-slate-200 font-bold text-2xl gap-x-2 sm:gap-x-4">
                ...
                <div class="swiper educational-calendar-slider mt-10 rounded-xl bg-gradient-to-r from-transparent to-blue-200 dark:to-dark-900 swiper-initialized swiper-horizontal swiper-rtl swiper-backface-hidden">
                    <!-- Additional required wrapper -->
                    ...
                    <!-- If we need scrollbar -->
                    <div class="swiper-scrollbar swiper-scrollbar-horizontal swiper-scrollbar-lock" style="display: none;"><div class="swiper-scrollbar-drag" style="width: 100px; transform: translate3d(0px, 0px, 0px);"></div></div>
                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
        ...
        <section class="mt-20">
            <div class="container">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 mt-10 gap-y-16 sm:gap-10 px-8 py-16 rounded-xl bg-gradient-to-r from-transparent to-red-200 dark:to-dark-900">
                    <div>
                        <h4 class="text-lg font-bold mb-4 dark:text-slate-200">
                            از گوشه و کنار جهان برای آموختن
                        </h4>
                        <p class="text-slate-600 dark:text-slate-400">
                        جامعه الزهرا (س) با رویکردی بین‌المللی، یکی از مهم‌ترین مراکز آموزشی و تربیتی ویژه بانوان در جهان اسلام است که به تربیت و آموزش بانوان طلبه از سراسر جهان می‌پردازد. این مرکز در قم با برگزاری دوره‌های متنوع علوم اسلامی و انسانی و ارائه برنامه‌های تخصصی در حوزه تبلیغ و پژوهش، به بانوان از ملیت‌های مختلف امکان می‌دهد تا درک عمیق‌تری از آموزه‌های دینی پیدا کرده و در ترویج معارف اسلامی در جوامع خود نقش مؤثری ایفا کنند. جامعه الزهرا (س) در راستای گسترش دیپلماسی فرهنگی و توسعه ارتباطات بین‌المللی در حوزه علوم اسلامی، بستری مناسب برای تعامل علمی و فرهنگی میان بانوان از کشورهای مختلف فراهم می‌کند.                        </p>
                    </div>
                    <div class="grid grid-cols-2 gap-6 text-slate-600 dark:text-slate-400">
                        <div class="flex flex-row items-center">
                            <a href="#" class="flex items-center text-2xl bg-blue-600 text-white px-3 pt-4 pb-3 rounded-b-md rounded-t-[100%]">
    ...
    <footer class="dark:bg-dark-850 pt-24 pb-10">
        <div class="container">
            <div class="relative">
                <span class="absolute border-t border-1 sm:top-2/4 top-5 trasform sm:translate-y-2/4 dark:border-slate-600 w-full z-0 right-0"></span>
                        ...
                        <li class="mr-2">
                            <a href="#" class="group flex items-center rounded justify-center w-10 h-10 dark:hover:bg-blue-970 dark:bg-blue-800 dark:bg-opacity-25 bg-blue-50 group hover:bg-blue-700 transition duration-300 ease-linear" rel="nofollow">
                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path class="fill-current transition duration-300 ease-linear dark:text-blue-300 text-blue-700 group-hover:text-white" d="M13.8911 4.37544C13.8911 4.89486 13.4694 5.31345 12.9531 5.31345C12.4337 5.31345 12.0151 4.8918 12.0151 4.37544C12.0151 3.85603 12.4367 3.43744 12.9531 3.43744C13.4694 3.43744 13.8911 3.85909 13.8911 4.37544Z">
                                    </path>
                                </svg>
                            </a>
                        </li>
            ...
            <div class="grid md:grid-cols-9 grid-cols-1 xl:gap-20 gap-7 mt-10 p-4 rounded-xl bg-gradient-to-br from-transparent from-60% to-blue-200 dark:to-dark-900">
                <div class="md:col-span-4">
                    ...
                    <div class="flex relative ">
                        ...
                        <div class="md:mr-2 md:text-right text-center">
                            <p class="text-base mb-2 md:w-10/12 w-full md:text-right text-center leading-7 dark:text-slate-400 text-slate-600">
                ...
                <div class="md:col-span-2">
                    ...
                    <ul class="flex flex-col md:items-start items-center dark:text-slate-400">
                        <li class="mb-3 last:mb-0 flex items-center">
                            <span class="md:flex hidden w-1 h-1 ml-2 mb-1 dark:text-gray-940 bg-blue-700 opacity-30 rounded-full"></span>
                            <a class="text-base text-slate-600 dark:text-slate-400 transform dark:hover:text-blue-450  duration-200 ease-linear hover:text-blue-600 dark:hover:text-blue-400 transition-all hover:mr-2" href="terms">قوانین و مقررات </a>
                        </li>
                        <li class="mb-3 last:mb-0 flex items-center">
                            <span class="md:flex hidden  w-1 h-1 ml-2 mb-1 bg-blue-700 opacity-30 rounded-full"></span>
                            <a class="text-base text-slate-600 dark:text-slate-400 transform dark:hover:text-blue-450  duration-200 ease-linear hover:text-blue-600 dark:hover:text-blue-400 transition-all hover:mr-2" href="masters">مدرسان دانشگاه </a>
                        </li>
                        <li class="mb-3 last:mb-0 flex items-center">
                            <span class="md:flex hidden w-1 h-1 ml-2 mb-1 dark:text-gray-940 bg-blue-700 opacity-30 rounded-full"></span>
                            <a class="text-base text-slate-600 dark:text-slate-400 transform dark:hover:text-blue-450  duration-200 ease-linear hover:text-blue-600 dark:hover:text-blue-400 transition-all hover:mr-2" href="about-us">درباره دانشگاه </a>
                        </li>
                        <li class="mb-3 last:mb-0 flex items-center">
                            <span class="md:flex hidden w-1 h-1 ml-2 mb-1 dark:text-gray-940 bg-blue-700 opacity-30 rounded-full"></span>
                            <a class="text-base text-slate-600 dark:text-slate-400 transform dark:hover:text-blue-450  duration-200 ease-linear hover:text-blue-600 dark:hover:text-blue-400 transition-all hover:mr-2" href="contact-us">ارتباط با ما</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <li class="flex items-center justify-between mb-7 last:mb-0 dark:text-slate-400">
                            <span class="flex items-center">
                                <span class="relative ml-3">
                                    ...
                                    <svg class="dark:text-blue-300 text-blue-980 absolute -top-1 -left-2" width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="dark:text-white text-slate-600 dark:hover:text-blue-450 font-medium text-sm transition transform duration-200 ease-linear hover:text-blue-600 dark:hover:text-blue-400 transition-all hover:ml-2" href="mailto:int@jz.ac.ir">int@jz.ac.ir</a>
                        </li>
                        <li class="flex items-center justify-between mb-7 last:mb-0">
                            <span class="flex items-center">
                                <span class="relative ml-3">
                                    <i class="flex w-5 h-5 bg-blue-700 opacity-20 rounded-full"></i>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="dark:text-blue-300 text-blue-980 absolute -top-1 -left-2" viewBox="0 0 17 17">
                            ...
                            <a class="dark:text-white  text-slate-600 dark:hover:text-blue-450 font-medium text-sm transition ltr transform duration-200 ease-linear hover:text-blue-600 dark:hover:text-blue-400 transition-all hover:ml-2" href="tel:09374959089">
                                02532112010
                            </a>
                        </li>
            ...
            <div>
                <div class="flex items-center justify-center text-sm text-center sm:text-right md:justify-between flex-wrap gap-y-2 gap-x-4 mt-8 sm:mt-10 dark:text-neutral-300">
                    <span>
